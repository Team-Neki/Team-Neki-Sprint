-- BACKLOG 상태 제거: 기존 BACKLOG 행은 TODO 로 이관 후 enum 재생성.
UPDATE "Task" SET "status" = 'TODO' WHERE "status" = 'BACKLOG';
UPDATE "Epic" SET "status" = 'TODO' WHERE "status" = 'BACKLOG';
UPDATE "Project" SET "status" = 'TODO' WHERE "status" = 'BACKLOG';
...
ALTER TABLE "Epic" ALTER COLUMN "status" SET DEFAULT 'TODO';
