...
/** 프로젝트 행 삭제 확인 문구(`EntityTable` `deleteDescription`). */
export const PROJECT_DELETE_DESCRIPTION =
  "프로젝트가 삭제됩니다. 하위 에픽은 삭제되지 않고 프로젝트 연결만 해제됩니다.";
 ...
 */
export const PROJECT_COLUMNS: ColumnDef<ProjectTableRow, ProjectEditContext>[] =
  [
    {
      key: "title",
      label: "제목",
...
export const PROJECTS_COLUMNS_META: ColumnMeta[] = PROJECT_COLUMNS.map((c) => ({
  key: c.key,
  label: c.label,
}));
